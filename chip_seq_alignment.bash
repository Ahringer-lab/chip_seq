...
#      bwaindex = The folder where the build bwa index is located, the default is the Ahringer built genomes folder for bwa
...
bamCoverage -p ${THREADS} --normalizeUsing CPM -bs 10 -b ${analysis_out_dir}/${base}/bwa/${base}.sorted.bam -o ${analysis_out_dir}/bw/${base}.bw
